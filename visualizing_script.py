...
def get_config():
    ...
    parser.add_argument("--threshold", type=float, default=0.7, help="Resnet face inplanes")
...
def fig2img(fig):
    ...
    img = Image.open(buf)
    return img
def validate_images(image,gazemap_gn,gazemap_pred,vector,epoch,sorted_list=None,Title_figure_3="Pred"):
