...
def get_config():
    ...
    parser.add_argument("--resnet_scene_inplanes", type=int, default=64, help="Resnet scene inplanes")
    parser.add_argument("--resnet_face_inplanes", type=int, default=64, help="Resnet face inplanes")
    parser.add_argument("--unet_inout_channels", type=int, default=1, help="Unet input output channels")
    ...
    parser.add_argument("--ema_on", default=False, action="store_true", help="Work with the EMA weights") # it is not working idk why this is happening
    ...
    # Update output dir
    args.model_id = f"spatial_depth_late_fusion_{args.source_dataset}"
